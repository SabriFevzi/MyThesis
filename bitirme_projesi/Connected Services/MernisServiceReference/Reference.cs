...
namespace MernisServiceReference
{
    ...
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<MernisServiceReference.KPSPublicSoap>, MernisServiceReference.KPSPublicSoap
    {
        ...
        public System.Threading.Tasks.Task<MernisServiceReference.TCKimlikNoDogrulaResponse> TCKimlikNoDoğrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili)
        {
		...
		internal bool TCKimlikNoDoğrulaAsync(string nationalityId, string v1, string v2, int year)
		{
			throw new NotImplementedException();
		}

		internal bool TCKimlikNoDoğrula(string nationalityId, string v1, string v2, object year)
		{
			throw new NotImplementedException();
		}
